...
const gamesData = [
  ...
  },
  {
    ...
    description: "Build and optimize renewable power grids to meet demand",
    longDescription:
      "Plan solar, wind, and storage to power a virtual region. Balance cost, reliability, and emissions.",
    difficulty: "Medium" as const,
    duration: "15-30 min",
    players: 7120,
    rating: 4.7,
    ...
    rewards: {
      xp: 120,
      coins: 70,
      badges: ["Grid Planner", "Clean Power Pro"],
    },
    isNew: true,
    isPopular: true,
  },
  {
    ...
    description: "Respond to climate threats and protect communities",
    longDescription: "Tackle heatwaves, floods, and wildfires with smart adaptation choices while reducing emissions.",
    difficulty: "Hard" as const,
    duration: "20-40 min",
    players: 5380,
    rating: 4.6,
    ...
    rewards: {
      xp: 140,
      coins: 90,
      badges: ["Resilience Builder", "Risk Reducer"],
    },
    isNew: false,
    isPopular: false,
  },
  {
    id: "9",
    title: "Recycling Lab",
    description: "Diagnose tricky items and choose correct disposal paths",
    longDescription: "From e-waste to compostables, test your knowledge and improve real-world sorting habits.",
    difficulty: "Easy" as const,
    duration: "8-12 min",
    players: 8450,
    rating: 4.5,
  ...
  {
    id: "10",
    title: "Eco Park Designer",
    description: "Design a biodiverse eco-park inside the city",
    longDescription: "Place native habitats, wetlands, and corridors to boost biodiversity and community wellness.",
    difficulty: "Medium" as const,
    duration: "12-25 min",
    players: 6025,
    rating: 4.7,
    ...
    rewards: {
      xp: 100,
      coins: 60,
      badges: ["Habitat Hero", "Urban Naturalist"],
    },
    isNew: false,
    isPopular: true,
  },
